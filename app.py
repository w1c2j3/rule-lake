...
ITEM_TRANSLATIONS = {
    ...
    "waffles": "华夫饼",
    "salty snack": "咸味零食",
    "long life bakery product": "长保质期烘焙品",
    "sugar": "糖",
    "butter milk": "酪乳",
    "ham": "火腿",
    "meat": "肉类",
    ...
    "specialty chocolate": "特色巧克力",
    "specialty bar": "特色棒类零食",
    "herbs": "香草",
    "grapes": "葡萄",
    "candy": "糖果",
    "frozen meals": "冷冻餐",
    ...
    "dishes": "餐具",
    "ground beef": "碎牛肉",
    "whipped/sour cream": "打发奶油/酸奶油",
    "cake": "蛋糕",
    "Cake": "蛋糕",
    "Sandwich": "三明治",
    "escalope": "薄肉片",
    "whole wheat rice": "全麦米",
    "grated cheese": "磨碎奶酪",
    "soup": "汤",
    "Soup": "汤",
    "herb & pepper": "香草和胡椒",
    ...
    "UHT-milk": "常温奶",
    "Alfajores": "夹心饼干",
    "hygiene articles": "卫生用品",
    "fresh bread": "新鲜面包",
    "Toast": "吐司",
    "Scone": "司康",
    "white wine": "白葡萄酒",
    "red wine": "红葡萄酒",
    "red/blush wine": "桃红葡萄酒",
    "misc. beverages": "其他饮料",
    "beverages": "饮料",
    "cereals": "谷物麦片",
    "sliced cheese": "切片奶酪",
    ...
    "yogurt cake": "酸奶蛋糕",
    "vegetables mix": "混合蔬菜",
    "pickled vegetables": "腌制蔬菜",
    "Truffles": "松露巧克力",
    "baking powder": "泡打粉",
    "salt": "盐",
    "Spanish Brunch": "西班牙早午餐",
    "french wine": "法国葡萄酒",
    "semi-finished bread": "半成品面包",
    "fresh tuna": "新鲜金枪鱼",
    "pot plants": "盆栽植物",
    "muffins": "松饼",
    "meatballs": "肉丸",
    ...
    "mushroom cream sauce": "蘑菇奶油酱",
    "Coke": "可乐",
    "Tiffin": "茶点",
    "seasonal products": "季节性商品",
    "mayonnaise": "蛋黄酱",
    "cake bar": "蛋糕棒",
    "protein bar": "蛋白棒",
    "mint": "薄荷",
    "packaged fruit/vegetables": "包装水果/蔬菜",
    "Jammie Dodgers": "果酱夹心饼干",
    "mustard": "芥末酱",
    "light cream": "淡奶油",
    "carrots": "胡萝卜",
    "frozen fish": "冷冻鱼",
    "spread cheese": "涂抹奶酪",
    "cling film/bags": "保鲜膜/保鲜袋",
    "black tea": "红茶",
    "Chicken Stew": "炖鸡",
    "frozen dessert": "冷冻甜点",
    "tomato sauce": "番茄酱",
    ...
    "gums": "软糖",
    "Baguette": "法棍",
    "extra dark chocolate": "特黑巧克力",
    "sweet spreads": "甜味涂抹酱",
    "body spray": "身体喷雾",
    "specialty cheese": "特色奶酪",
    "pet care": "宠物护理用品",
    "melons": "甜瓜",
    "chocolate marshmallow": "巧克力棉花糖",
    "candles": "蜡烛",
    "frozen potato products": "冷冻土豆制品",
    "barbecue sauce": "烧烤酱",
    "yams": "山药",
    "magazines": "杂志",
    "cider": "苹果酒",
    "house keeping products": "家居清洁用品",
    "Frittata": "意式煎蛋",
    "Instant food products": "速食食品",
    "nonfat milk": "脱脂牛奶",
    "liquor (appetizer)": "开胃酒",
    "ketchup": "番茄沙司",
    "Smoothies": "冰沙",
    "zucchini": "西葫芦",
    "popcorn": "爆米花",
    "instant coffee": "速溶咖啡",
    "whole weat flour": "全麦面粉",
    "green grapes": "青葡萄",
    "flax seed": "亚麻籽",
    "blueberries": "蓝莓",
    "soups": "汤类",
    ...
    "bug spray": "驱虫喷雾",
    "bacon": "培根",
    "Keeping It Local": "本地特色餐",
    "zwieback": "烤脆面包干",
    "green beans": "四季豆",
    "clothes accessories": "服饰配件",
    "antioxydant juice": "抗氧化果汁",
    "finished products": "成品食品",
    "kitchen towels": "厨房纸巾",
    "toothpaste": "牙膏",
    "strong cheese": "浓味奶酪",
    "female sanitary products": "女性卫生用品",
    "dental care": "口腔护理",
    "shallot": "红葱头",
    "sauces": "酱料",
    "The Nomad": "游牧风味餐",
    ...
    "champagne": "香槟",
    "cookies": "饼干",
    "ALARM CLOCK BAKELIKE GREEN": "绿色复古闹钟",
    "ALARM CLOCK BAKELIKE PINK": "粉色复古闹钟",
    "ALARM CLOCK BAKELIKE RED": "红色复古闹钟",
    "LUNCH BAG RED RETROSPOT": "红色复古圆点午餐袋",
    "LUNCH BAG WOODLAND": "森林图案午餐袋",
    "LUNCH BAG SPACEBOY DESIGN": "太空男孩午餐袋",
    "LUNCH BAG SUKI DESIGN": "Suki 图案午餐袋",
    "LUNCH BAG APPLE DESIGN": "苹果图案午餐袋",
    "JUMBO BAG RED RETROSPOT": "红色复古圆点大号袋",
    "JUMBO BAG SPACEBOY DESIGN": "太空男孩大号袋",
    "JUMBO BAG WOODLAND ANIMALS": "森林动物大号袋",
    "JUMBO BAG APPLES": "苹果图案大号袋",
    "RED RETROSPOT MINI CASES": "红色复古圆点小盒",
    "RED TOADSTOOL LED NIGHT LIGHT": "红蘑菇 LED 夜灯",
    "ROUND SNACK BOXES SET OF4 WOODLAND": "森林图案圆形零食盒四件套",
    "ROUND SNACK BOXES SET OF 4 FRUITS": "水果图案圆形零食盒四件套",
    "LUNCH BOX WITH CUTLERY RETROSPOT": "复古圆点带餐具午餐盒",
    "LUNCH BOX I LOVE LONDON": "我爱伦敦午餐盒",
    "SPACEBOY LUNCH BOX": "太空男孩午餐盒",
    "DOLLY GIRL LUNCH BOX": "娃娃女孩午餐盒",
    "STRAWBERRY LUNCH BOX WITH CUTLERY": "草莓带餐具午餐盒",
    "SKULL LUNCH BOX WITH CUTLERY": "骷髅图案带餐具午餐盒",
    "PLASTERS IN TIN SPACEBOY": "太空男孩铁盒创可贴",
    "PLASTERS IN TIN WOODLAND ANIMALS": "森林动物铁盒创可贴",
    "PLASTERS IN TIN CIRCUS PARADE": "马戏巡游铁盒创可贴",
    "PLASTERS IN TIN STRONGMAN": "大力士铁盒创可贴",
    "REGENCY CAKESTAND 3 TIER": "三层摄政风蛋糕架",
    "PACK OF 72 RETROSPOT CAKE CASES": "72 个复古圆点蛋糕纸托",
    "SET/20 RED RETROSPOT PAPER NAPKINS": "20 张红色复古圆点纸巾",
    "SET/6 RED SPOTTY PAPER CUPS": "6 个红色圆点纸杯",
    "SET/6 RED SPOTTY PAPER PLATES": "6 个红色圆点纸盘",
    "SET/10 RED POLKADOT PARTY CANDLES": "10 支红色圆点派对蜡烛",
    "SET OF 2 TEA TOWELS APPLE AND PEARS": "苹果梨图案茶巾两件套",
    "TABLECLOTH RED APPLES DESIGN": "红苹果图案桌布",
    "CHARLOTTE BAG DOLLY GIRL DESIGN": "娃娃女孩夏洛特袋",
    "CHARLOTTE BAG PINK POLKADOT": "粉色圆点夏洛特袋",
    "CHARLOTTE BAG APPLES DESIGN": "苹果图案夏洛特袋",
    "WOODLAND CHARLOTTE BAG": "森林图案夏洛特袋",
    "RED RETROSPOT CHARLOTTE BAG": "红色复古圆点夏洛特袋",
    "GUMBALL COAT RACK": "糖果球衣帽架",
    "JAM MAKING SET PRINTED": "印花果酱制作套装",
    "JAM MAKING SET WITH JARS": "带罐果酱制作套装",
    "PARTY BUNTING": "派对旗帜",
    "PAPER BUNTING RETROSPOT": "复古圆点纸旗",
    "TEA PARTY BIRTHDAY CARD": "茶会生日卡",
    "SPACEBOY BIRTHDAY CARD": "太空男孩生日卡",
    "POPPY'S PLAYHOUSE KITCHEN": "Poppy 玩具屋厨房",
    "BLUE HARMONICA IN BOX": "盒装蓝色口琴",
    "RED HARMONICA IN BOX": "盒装红色口琴",
    "ASSORTED COLOUR MINI CASES": "混色小盒",
    "MINI PAINT SET VINTAGE": "复古迷你颜料套装",
    "BAKING SET 9 PIECE RETROSPOT": "9 件复古圆点烘焙套装",
    "WHITE HANGING HEART T-LIGHT HOLDER": "白色悬挂爱心小烛台",
    "RED HANGING HEART T-LIGHT HOLDER": "红色悬挂爱心小烛台",
    "PAPER CHAIN KIT 50'S CHRISTMAS": "50 年代圣诞纸链套装",
    "PAPER CHAIN KIT VINTAGE CHRISTMAS": "复古圣诞纸链套装",
    "RABBIT NIGHT LIGHT": "兔子夜灯",
    "HEART OF WICKER SMALL": "小号藤编爱心",
    "HEART OF WICKER LARGE": "大号藤编爱心",
    "RETROSPOT TEA SET CERAMIC 11 PC": "复古圆点陶瓷茶具 11 件套",
    "CHOCOLATE HOT WATER BOTTLE": "巧克力色热水袋",
    "6 RIBBONS RUSTIC CHARM": "乡村风丝带 6 件套",
    "ROSES REGENCY TEACUP AND SAUCER": "玫瑰摄政风茶杯碟",
    "GREEN REGENCY TEACUP AND SAUCER": "绿色摄政风茶杯碟",
    "VINTAGE SNAP CARDS": "复古纸牌",
    "SCOTTIE DOG HOT WATER BOTTLE": "苏格兰犬热水袋",
    "ASSORTED COLOUR BIRD ORNAMENT": "混色鸟形装饰",
    "RECIPE BOX PANTRY YELLOW DESIGN": "黄色厨房食谱盒",
    "HOT WATER BOTTLE TEA AND SYMPATHY": "茶与慰问图案热水袋",
    "SET OF 3 REGENCY CAKE TINS": "摄政风蛋糕罐三件套",
    "PLEASE ONE PERSON METAL SIGN": "单人提示金属牌",
    "HAND WARMER OWL DESIGN": "猫头鹰图案暖手包",
    "NATURAL SLATE HEART CHALKBOARD": "天然石板爱心黑板",
    "60 TEATIME FAIRY CAKE CASES": "60 个茶点小蛋糕纸托",
    "SET OF 3 CAKE TINS PANTRY DESIGN": "厨房图案蛋糕罐三件套",
    "COOK WITH WINE METAL SIGN": "用酒烹饪金属牌",
    "COFFEE MUG APPLES DESIGN": "苹果图案咖啡杯",
    "PACK OF 60 PINK PAISLEY CAKE CASES": "60 个粉色佩斯利蛋糕纸托",
    "IVORY KITCHEN SCALES": "象牙色厨房秤",
    "CLOTHES PEGS RETROSPOT PACK 24": "复古圆点衣夹 24 件装",
    "WOODEN FRAME ANTIQUE WHITE": "古董白木相框",
    "STRAWBERRY CERAMIC TRINKET BOX": "草莓陶瓷首饰盒",
    "RETROSPOT PARTY BAG + STICKER SET": "复古圆点派对袋和贴纸套装",
    "RED RETROSPOT CUP": "红色复古圆点杯",
    "CHILDRENS CUTLERY DOLLY GIRL": "娃娃女孩儿童餐具",
    "CHILDRENS CUTLERY SPACEBOY": "太空男孩儿童餐具",
    "4 TRADITIONAL SPINNING TOPS": "4 个传统陀螺",
    "Afternoon with the baker": "烘焙师下午茶",
    "Art Tray": "艺术托盘",
    "BATHROOM METAL SIGN": "浴室金属牌",
    "Bacon": "培根",
    "Bakewell": "贝克韦尔点心",
    "Bare Popcorn": "原味爆米花",
    "Bowl Nic Pitt": "Nic Pitt 碗",
    "Brioche and salami": "布里欧修面包和萨拉米",
    "CARRIAGE": "运费",
    "CHILLI LIGHTS": "辣椒造型灯",
    "CIRCUS PARADE CHILDRENS EGG CUP": "马戏巡游儿童蛋杯",
    "Caramel bites": "焦糖小点",
    "Chimichurri Oil": "阿根廷香草油",
    "Chocolates": "巧克力",
    "Crepes": "可丽饼",
    "Crisps": "薯片",
    "DOORMAT FANCY FONT HOME SWEET HOME": "花体字家门垫",
    "DOORMAT NEW ENGLAND": "新英格兰门垫",
    "Duck egg": "鸭蛋",
    "Dulce de Leche": "牛奶焦糖酱",
    "EDWARDIAN PARASOL NATURAL": "爱德华风自然色阳伞",
    "Eggs": "鸡蛋",
    "Empanadas": "南美馅饼",
    "Extra Salami or Feta": "额外萨拉米或菲达奶酪",
    "FRENCH ENAMEL CANDLEHOLDER": "法式搪瓷烛台",
    "Fairy Doors": "童话小门",
    "Focaccia": "佛卡夏面包",
    "Fudge": "乳脂软糖",
    "GIN + TONIC DIET METAL SIGN": "低卡金汤力金属牌",
    "GINGERBREAD MAN COOKIE CUTTER": "姜饼人饼干模具",
    "Gift voucher": "礼品券",
    "Gingerbread syrup": "姜饼糖浆",
    "Granola": "格兰诺拉麦片",
    "HOLIDAY FUN LUDO": "假日飞行棋",
    "HOME BUILDING BLOCK WORD": "HOME 字母积木",
    "HOMEMADE JAM SCENTED CANDLES": "自制果酱香薰蜡烛",
    "Hack the stack": "叠叠乐点心",
    "Half slice Monster": "半片怪兽蛋糕",
    "Hearty & Seasonal": "丰盛季节餐",
    "Honey": "蜂蜜",
    "Kids biscuit": "儿童饼干",
    "Lemon and coconut": "柠檬椰子点心",
    "MEMO BOARD COTTAGE DESIGN": "乡村风留言板",
    "Mighty Protein": "高蛋白食品",
    "Mortimer": "Mortimer 特色餐",
    "Muesli": "穆兹利麦片",
    "Olum & polenta": "Olum 和玉米粥",
    "PHOTO FRAME 3 CLASSIC HANGING": "三联经典悬挂相框",
    "PHOTO FRAME CORNICE": "檐口造型相框",
    "Panatone": "潘娜托尼面包",
    "Pick and Mix Bowls": "自选混合碗",
    "Pintxos": "巴斯克小食",
    "Polenta": "玉米粥",
    "Postcard": "明信片",
    "REGENCY TEAPOT ROSES": "玫瑰摄政风茶壶",
    "REVOLVER WOODEN RULER": "左轮造型木尺",
    "Raspberry shortbread sandwich": "覆盆子黄油酥夹心",
    "Raw bars": "生食能量棒",
    "SCANDINAVIAN REDS RIBBONS": "北欧红色丝带",
    "SPOTTY BUNTING": "圆点旗帜",
    "SWEETHEART RECIPE BOOK STAND": "甜心食谱书架",
    "Salad": "沙拉",
    "Spread": "涂抹酱",
    "Tacos/Fajita": "塔可/法士达",
    "The BART": "BART 特色餐",
    "Tshirt": "T 恤",
    "Vegan Feast": "素食套餐",
    "Victorian Sponge": "维多利亚海绵蛋糕",
    "abrasive cleaner": "磨砂清洁剂",
    "artif. sweetener": "人工甜味剂",
    "asparagus": "芦笋",
    "babies food": "婴儿食品",
    "baby cosmetics": "婴儿护理用品",
    "baby food": "婴儿食品",
    "bathroom cleaner": "浴室清洁剂",
    "bramble": "黑莓",
    "brandy": "白兰地",
    "cauliflower": "花椰菜",
    "chili": "辣椒",
    ...
    "corn": "玉米",
    "decalcifier": "除垢剂",
    "flower soil/fertilizer": "花土/肥料",
    "gluten free bar": "无麸质能量棒",
    "hair spray": "发胶",
    "hand protein bar": "手持蛋白棒",
    "liqueur": "利口酒",
    "make up remover": "卸妆用品",
    "male cosmetics": "男士护理用品",
    "mashed potato": "土豆泥",
    "nuts/prunes": "坚果/西梅",
    "oatmeal": "燕麦粥",
    "organic products": "有机商品",
    "organic sausage": "有机香肠",
    "pet food": "宠物食品",
    "pickles": "腌黄瓜",
    "potato products": "土豆制品",
    "preservation products": "保鲜用品",
    "prosecco": "普罗塞克起泡酒",
    "pudding powder": "布丁粉",
    "ready soups": "即食汤",
...
DATASETS = {
    "uci_france": {
        ...
        "origin_note": "来自 UCI Online Retail 真实线上零售交易，筛选国家为 France 的正向订单；数据不是某一家超市，而是英国注册线上零售商面向法国客户的礼品、家居和派对用品订单。",
        "data_note": "每一行是一张发票聚合后的购物篮，商品多为午餐袋、复古圆点纸品、夜灯、蛋糕架等零售小商品，适合展示跨品类组合购买关系。",
        "usage_note": "适合答辩中说明“法国客户偏好”：例如红色复古圆点、午餐袋、零食盒、派对用品之间的共购规则。",
    ...
    "uci_germany": {
        ...
        "origin_note": "来自同一份 UCI Online Retail 线上零售交易，筛选国家为 Germany 的正向订单；可理解为德国客户在跨境线上礼品店中的真实购物篮。",
        "data_note": "交易以发票为单位聚合，商品仍以家居装饰、节日礼品、包装袋和小型生活用品为主，和 France 子集共享来源但购买偏好不同。",
        "usage_note": "适合与 France、EIRE、UK 做跨数据湖对比，观察相同零售商在不同地区客户中的高频商品和规则差异。",
        "recommended_support": 0.06,
        "recommended_confidence": 0.50,
    },
    "uci_eire": {
        ...
        "origin_note": "来自 UCI Online Retail 的 EIRE 爱尔兰客户订单，代表同一线上零售商在爱尔兰市场的购物篮数据。",
        "data_note": "数据包含真实发票聚合后的礼品、厨房用品、装饰品和节日商品组合，篮子通常比课堂玩具数据更贴近真实零售场景。",
        "usage_note": "适合展示区域市场差异，也适合和 UK 子集比较同一语言文化圈下的商品共购模式。",
        "recommended_support": 0.06,
        "recommended_confidence": 0.50,
    },
    "uci_uk": {
        ...
        "origin_note": "来自 UCI Online Retail 中 United Kingdom 本土客户订单，是该线上零售商最大、最核心的市场子集。",
        "data_note": "购物篮覆盖礼品、收纳袋、纸品、厨房装饰和季节性商品，交易数量更大，适合观察更稳定的频繁项集。",
        "usage_note": "适合用于说明样本规模对支持度和规则数量的影响，也适合与其他国家子集做横向对比。",
    ...
    "groceries": {
        ...
        "origin_note": "来自 arules Groceries 经典公开购物篮数据，常被用于关联规则挖掘教学；它不指向具体超市品牌，更像匿名杂货超市的收银篮子记录。",
        "data_note": "商品包括全脂牛奶、蔬菜、面包、酸奶、香肠、瓶装水等日常食品，结构非常接近传统线下超市小票。",
        "usage_note": "适合讲 Apriori 的基本概念：食品类商品支持度高、共购关系直观，例如牛奶、面包、蔬菜和酸奶的组合。",
    ...
    "bread_basket": {
        ...
        "origin_note": "来自公开 Bread Basket Bakery 数据，记录一家面包咖啡店的真实交易明细，适合模拟咖啡店或烘焙门店的连带销售分析。",
        "data_note": "商品包括 Bread、Coffee、Tea、Pastry、Cake、Sandwich 等，交易场景集中在早餐、下午茶和简餐。",
        "usage_note": "适合展示小型门店推荐：例如买咖啡的人是否更常同时购买面包、糕点、三明治或蛋糕。",
    ...
    "market_basket_grocery": {
        ...
        "origin_note": "来自公开 Market Basket Analysis 示例数据，可理解为匿名杂货/便利零售门店的购物篮记录，不绑定具体商超品牌。",
        "data_note": "商品覆盖矿泉水、鸡蛋、意大利面、薯条、绿茶、牛奶、汉堡、冷冻蔬菜等，兼具食品、饮料和半成品餐食。",
        "usage_note": "适合做推荐模拟器演示：商品名称通俗，规则容易解释，能展示“已有购物篮 -> 推荐补充商品”的业务流程。",
        "recommended_support": 0.02,
        "recommended_confidence": 0.30,
    },
}
...
def item_translation(name):
    """返回商品中文注释；未精确登记时用词根生成一个可读兜底。"""
    text = str(name or "").strip()
    if not text:
        return ""
    if text in ITEM_TRANSLATIONS:
        return ITEM_TRANSLATIONS[text]

    tokens = re.findall(r"[A-Za-z0-9]+", text)
    translated = []
    for token in tokens:
        value = ITEM_TOKEN_TRANSLATIONS.get(token.lower())
...
def join_items_with_cn(items):
    """用英文（中文）格式连接项集，供自动分析文字展示。"""
    labels = []
    for item in items:
        cn = item_translation(item)
        labels.append(f"{item}（{cn}）" if cn and cn != item else item)
    return "、".join(labels)
...
def build_analysis(frequent_itemsets, rules):
    ...
    if top_pairs:
        names = "；".join(
            f"{join_items_with_cn(row['items'])}（支持度 {format_percent(row['support'])}）"
    ...
    if top_confidence_rules:
        rule_text = "；".join(
            f"{join_items_with_cn(row['antecedent'])} -> {join_items_with_cn(row['consequent'])}"
    ...
    if lift_rules:
        ...
        analysis.append(
            ...
            f"{join_items_with_cn(best['antecedent'])} -> {join_items_with_cn(best['consequent'])}，"
            f"lift={best['lift']:.2f}。"
        )
    else:
...
def compact_rule(rule):
    ...
    return {
        ...
        "lift": rule["lift"],
        "text": f"{join_items_with_cn(rule['antecedent'])} -> {join_items_with_cn(rule['consequent'])}",
    }
...
def build_algorithm_comparison(dataset_id, min_support, min_confidence, max_transactions):
    ...
    if strongest and strongest["best_rule"]:
        ...
        analysis.append(
            f"最高 lift 来自 {strongest['name']}：{join_items_with_cn(rule['antecedent'])} -> "
            f"{join_items_with_cn(rule['consequent'])}，lift={rule['lift']:.2f}。"
        )
